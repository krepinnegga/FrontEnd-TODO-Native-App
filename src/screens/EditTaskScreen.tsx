...
const EditTaskScreen = () => {
  ...
  const { trigger } = useSWRMutation("api/tasks/edit", updateTaskRequest)
  const { trigger: triggerDelete } = useSWRMutation("api/tasks/", deleteTaskRequest)
